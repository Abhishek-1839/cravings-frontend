...
import "./Footeropy.css"; // Create this CSS file for styling
  ...
  return (
    ...
    <footer className="footery">
      ...
      <div className="footer-sectionA">
        <h4 style={{marginBottom:"0px"}}>Legal Pages</h4>
        <ul style={{textDecoration:"underline", listStyle: "none",padding:"0px"}}>
      ...
      <div className="footer-sectionA">
        <h4 style={{marginBottom:"0px"}}>Important Links</h4>
        <ul style={{textDecoration:"underline", listStyle: "none",padding:"0px"}}>
    ...
    <div className="footer-bottom">
        <p className="copyright" style={{paddingLeft:"60px"}}>Order.uk Copyright 2024, All Rights Reserved.</p>
